...
<body>
    ...
    <div class="doctor-grid">
        <div class="doctor-card">
            <img src="images/doc1.png" alt="Dr. James Carter">
            <h4>Dr. James Carter</h4>
            <p>Specialization: General Symptoms</p>
            <p>Schedule: MW</p>
            <p>Time: 7:00-11:30AM</p>
            <p>ID: 20240301</p>
        </div>
        <div class="doctor-card">
            <img src="images/doc2.jpg" alt="Dr. Michael Thompson">
        ...
        <div class="doctor-card">
            <img src="images/doc3.jpg" alt="Dr. Daniel Williams">
            <h4>Dr. Daniel Williams</h4>
            <p>Specialization: General Symptoms</p>
            <p>Schedule: SS</p>
