...
<body>
    ...
    <div class="doctors-container">
        <div class="doctor-card">
            ...
            <img src="images/ped1.jpg" alt="Doctor 1">
            <h3>Name: Garcia, Geralyn MD</h3>
            <p>Specialization: Pediatric</p>
            <p>HMO-Accreditation: Avega, Intellicare, Maxicare, Medicard</p>
            <p>Schedule: MW</p>
        ...
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/ped2.jpg" alt="Doctor 2">
            <h3>Name: Medenlla, Lourdes MD</h3>
            <p>Specialization: Pediatric</p>
            <p>HMO-Accreditation: Avega, Intellicare, Maxicare, Medicard</p>
            <p>Schedule: TTH</p>
        ...
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/ped3.jpg" alt="Doctor 3">
            <h3>Name: Salvaña, Hannah M. MD</h3>
