...
<body>
    ...
    <div class="doctors-container">
        <div class="doctor-card">
            ...
            <img src="images/surge1.jpg" alt="Doctor 1">
            <h3>Name: Sta Cruz, Achilles C. MD</h3>
        ...
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/surge2.jpg" alt="Doctor 2">
            <h3>Name:  Docena, Maynard L. MD</h3>
            <p>Specialization: Surgery</p>
            <p>Sub-Specialty: Cardiology</p>
            <p>HMO-Accreditation: Avega, Intellicare, Maxicare, Medicard</p>
            <p>Schedule: TTH</p>
        ...
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/surge3.jpg" alt="Doctor 3">
            <h3>Name: Nunes, Rex E. MD</h3>
            <p>Specialization: Surgery</p>
            <p>HMO-Accreditation: Avega, Intellicare, Maxicare, Medicard</p>
            <p>Schedule: SS</p>
