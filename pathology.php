...
<body>
    <div class="header">
        ...
        <div class="title">Pathology</div>
    </div>
    <div class="doctors-container">
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/Path1.jpg" alt="Doctor 1">
            <h3>Name: Florentino, Alexander C. MD</h3>
            <p>Specialization: Pathology</p>
            <p>Schedule: MW</p>
        ...
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/path2.jpg" alt="Doctor 2">
            <h3>Name: Ramos, Celso S. MD</h3>
            <p>Specialization: Pathology</p>
            <p>Schedule: TTH</p>
