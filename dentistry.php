...
<body>
    ...
    <div class="doctors-container">
        <div class="doctor-card">
            ...
            <img src="images/den1.jpg" alt="Doctor 1">
            <h3>Name: Tesoro, Aileen A. DMD</h3>
            <p>Specialization: Dentistry</p>
            <p>Schedule: MW</p>
        ...
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/den2.jpg" alt="Doctor 2">
            <h3>Name: Bagtas, Jannette T. DMD</h3>
            <p>Specialization: Dentistry</p>
            <p>Schedule: TTH</p>
        ...
        <div class="doctor-card">
            <span class="status">ONLINE</span>
            <img src="images/den3.jpg" alt="Doctor 3">
            <h3>Name: Viterbo, Jonathan S. DMD</h3>
            <p>Specialization: Dentistry</p>
            <p>Schedule: SS</p>
